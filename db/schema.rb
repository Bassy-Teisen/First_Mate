...
ActiveRecord::Schema.define(version: 2021_11_15_053253) do
  ...
  create_table "applied_voyages", force: :cascade do |t|
    t.bigint "user_id", null: false
    t.bigint "voyage_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["user_id"], name: "index_applied_voyages_on_user_id"
    t.index ["voyage_id"], name: "index_applied_voyages_on_voyage_id"
  end
